...
public class WeatherProvider extends ContentProvider {
    ...
    private static SQLiteQueryBuilder sWeatherByLocationSettingQueryBuilder = null;
...
//            case WEATHER_WITH_LOCATION:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match){
            case WEATHER :
                Log.v("DELETE","Deleting weather table");
                nRows = db.delete(WeatherContract.WeatherEntry.TABLE_NAME,selection,selectionArgs);
                break;
            case LOCATION :
                Log.v("DELETE","Deleting location table");
                nRows = db.delete(WeatherContract.LocationEntry.TABLE_NAME,selection,selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown URI :" + uri);
        }
    ...
    public int update(
        ...
        int nRows;
        switch (match){
            case WEATHER : nRows = db.update(WeatherContract.WeatherEntry.TABLE_NAME,values,selection,selectionArgs);
                            break;
            case LOCATION : nRows = db.update(WeatherContract.LocationEntry.TABLE_NAME,values,selection,selectionArgs);
                break;
            default:
